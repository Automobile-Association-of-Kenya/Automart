...
class Account extends Model
{
    ...
    protected $fillable = ['provider', 'pp_client_id', 'pp_client_secret', 'pp_business_name', 'pp_card_number', 'pp_expiry', 'pp_cw', 'mpesa_secret', 'mpesa_customer_key', 'mpesa_pass_key', 'mpesa_business_short_code', 'mpesa_transaction_type'];
