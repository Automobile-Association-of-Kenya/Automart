                        ...
                        <tbody>
                            @foreach ($quotes as $item)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span>{{ $item->vehicle->year . ' ' . $item->vehicle->make->make . ' ' . $item->vehicle->model->model }}</span><br>
                                        <span><b>Ref NO: </b>{!! $item->vehicle->vehicle_no !!}</span><br>
                                        <span><b>Price: </b>{{ number_format($item->vehicle->price, 2) }}</span><br>
                                        <span><b>Mile age: </b>{!! $item->vehicle->mileage !!}</span><br>
                                        <span><b>CC: </b> {{ $item->vehicle->enginecc }}</span><br>
                                        <p class="mt-2"><span><b>Dealer: </b>&nbsp; {{ $dealer }} </span><br>
                                        <span><b>Email:</b>&nbsp;{{ $dealeremail }}</span>
                                        <br><span><b>Phone: </b>&nbsp;{{ $dealerphone }}</span></p>
                                    </td>
                            ...
                            @foreach ($loans as $item)
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <span><b>CC: </b>{{ $item->vehicle?->enginecc }}</span><br>
                                        <p class="mt-2"><span><b>Dealer: </b>&nbsp; {{ $dealer }}
                                            </span><br><span><b>Email:</b>&nbsp;{{ $dealeremail }}</span><br><span><b>Phone:
                                                </b>&nbsp;{{ $dealerphone }}</span></p>
                                    </td>

                                    <td>
                                        <span><b>Name:
                                            </b>{{ $item->title . '. ' . $item->firstname . ' ' . $item->lastname }}</span><br>
                                        <span><b>ID: </b>{!! $item->id_no !!}</span><br>
                                        <span><b>Tax Pin: </b> {{ $item->kra_pin }}</span><br>
                                    ...
                                    <td>
                                        <span><b>Industry: </b> {{ $item->industry->name }}</span><br>
                                        @if ($item->occupation === 'employment')
                                            <span><b>Occupation: </b>{!! $item->proffession !!}</span><br>
                                            <span><b>Years</b> {{ $item->years_of_employment }}</span><br>
                                            <span><b>Type</b> {{ $item->employement_type }}</span>
                                            <span><b>Employer: </b>{!! $item->employer !!}</span><br>
                                            <span><b>Address</b>&nbsp;{{ $item->employer_address }}</span><br>
                                            <span><b>Email: </b>{{ $item->email }}</span><br>
                                            <span><b>Phone: </b>{{ $item->phone }}</span><br>
                                        @endif
                                        @if ($item->business === 'yes')
                                            <span><b>Business: </b>{{ $item->business_name . '. ' . $item->businesstype }}</span><br>
                                            <span><b>Reg NO: </b>{!! $item->business_reg_no !!}</span><br>
                                            <span><b>Address: &nbsp;</b>{{ $item->businessaddress }}</span><br>
                                            <span><b>Owner: </b> {!! $item->businessowner === 'Owner'
                                                ? "<i class='fas fa-check-circle text-success'></i>"
                                                : "<b class='text-danger'>X</b>" !!}</span>
                                        @endif
                                    </td>
