                ...
                <div class="tab-content text-left" id="nav-tabContent">
                    ...
                    <div class="tab-pane fade show active" id="vehicledetails" role="tabpanel">
                        <div class="text-right">
                            <button class="btn btn-outline-danger mt-1 mb-1" id="filterToggle"><i
                        ...
                        <div class="bg-primary pb-3 pt-3 pl-2 pr-1 border-rounded filterSection"
                            ...
                            <form id="filterVehiclesForm" class="form-row">
                                ...
                                <div class="col-md-3">
                                    <label>Dealer</label>
                                    <select name="filterlistdealer_id" class="form-control  chzn-select" id="filterDealerID"
                                        style="width: 100%;">
                                    </select>
                                </div>
                                <div class="col-md-3">
                                ...
                                <div class="col-md-2">
                                    ...
                                    <select name="filterlistmodel_id" class="form-control  chzn-select" id="filterModelID"
                                        style="width: 100%;">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <select name="vehicleslist_id" style="width: 100%;" class="form-control  chzn-select"
                                        id="filterVehiclesID" style="width: 100%;">
                                    </select>
                                </div>
                                <div class="col-md-1">
