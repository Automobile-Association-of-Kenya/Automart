    ...
    <div id="5" class="">
        <div class="row" style="padding-bottom: 0px;">
            ...
            <div class="col-md-2">
                <!-- sidebar -->
                <div class="col-md-12 ">
                    <a href="{{ route('dealer.home') }}"> <button type="submit" class="btn  btn-block" style="background: #00472F;color:white;font-size:120%;text-align:left"><i class="fa fa-home"></i> Home</button></a>
                </div>
                <br>
                <div class="col-md-12">
                    <a href="{{ route('dealer.mycars') }}"><button type="submit" class="btn  btn-block" style="background: #00472F;color:white;font-size:120%;text-align:left"><i class="fa fa-car"></i> My Cars</button></a>
                </div>
                <br>
                <div class="col-md-12">
                    <a href="{{ route('dealer.subscriptions') }}"><button type="submit" class="btn  btn-block" style="background: #00472F;color:white;font-size:120%;text-align:left"><i class="fa fa-credit-card"></i> Subscriptions</button></a>
                </div>
                <div class="col-md-12">
                    <a href="{{ route('dealer.mysales') }}"><button type="submit" class="btn  btn-block" style="background: #00472F;color:white;font-size:120%;text-align:left"><i class="fa fa-money-bill"></i> My Sale</button></a>
                </div>
                <br>
                <div class="col-md-12">
                    <a href="{{ route('dealer.addcar') }}"><button type="submit" class="btn  btn-block" style="background: #00472F;color:white;font-size:120%;text-align:left"><i class="fa fa-plus"></i> Add Car</button></a>
                </div>
                <br>
                <div class="col-md-12">
                    <a href="{{ route('logout') }}"><button type="submit" class="btn  btn-block" style="background: #00472F;color:white;font-size:120%;text-align:left"> <i class="fa fa-sign-out-alt"></i> Logout</button></a>
                </div>
                <br>
            </div>
            ...
            <div class="col-md-10">
                ...
                <form action="{{ route('savecar') }}" method="POST" enctype="multipart/form-data" id="vehicleAdditionForm">
                    {{ csrf_field() }}
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 form-group">
                            <label>Model</label>
                            <select class="form-control form-control-sm" name="model" id="car_model" required aria-hidden="true" required>
                        ...
                        <div class="col-md-4 form-group">
                            ...
                            <select class="form-control form-control-sm" name="year" id="year" required>
                                @for ($i = date('Y', strtotime(now())); $i <= 1995; $i--) <option value="{{ $i }}">{{ $i }}</option>
                                    @endfor
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="row" style="padding-top:10px;">
                        <div class="col-md-4 form-group">
                            ...
                            <input class="form-control form-control-sm" type="number" id="price" name="price" placeholder="selling Price (Ksh)" required>
                        </div>
                        <div class=" col-md-4 form-group">
                            <label for="">Mileage</label>
                            <input class="form-control form-control-sm" type="number" id="miles" name="miles" placeholder="mileage (Kms)" required>
                        </div>
                        <div class=" col-md-4 form-group">
                            <label for="">Engine CC</label>
                            <input class="form-control form-control-sm" type="number" id="enginecc" name="enginecc" placeholder="Engine CC" required>
                        </div>
                    ...
                    <div class="row" style="color:#000;">
                        ...
                        <div class="col-md-3">
                            <input type="checkbox" value="Roof Racks" id="Roof Racks" name="features[]">&nbsp;&nbsp;&nbsp;Roof Racks
                        </div>
                        <div class="col-md-3">
                    ...
                    <div class="row" style="color:#000;">
                        <div class="col-md-3">
                            <input type="checkbox" value="Side Airbags" id="Side Airbags" name="features[]">&nbsp;&nbsp;&nbsp;Airbags
                        </div>
                        <div class="col-md-3">
                    ...
                    <div class="row">
                        <div class="col-md-4 form-group">
                            ...
                            <input type="file" name="images[]" placeholder="Upload Photos" id="multiImagesUpload" multiple=""><br>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="row">
                            <div class="col-6">
                                <input class="form-control" type="text" id="firstname" tabindex="22" name="firstname" placeholder="Enter first name" value="{{ $user->name }}" required style="text-transform:uppercase">
                            </div>
                            <div class="col-6">
                                <input class="form-control" type="text" id="gt-lastname" tabindex="23" name="lastname" placeholder="Enter last name" value="{{ $user->name }}" required style="text-transform:uppercase">
                            </div>
                        </div>
                        <div class="row" style="padding-top: 10px; padding-bottom: 10px;">
                            <div class="col-6">
                                <input class="form-control" type="email" id="email" tabindex="24" name="email" value="{{ $user->email }}" placeholder="Enter your e-mail address " required>
                            </div>
                            <div class="col-6">
                        ...
                        <div class="col-md-12">
                            <input type="checkbox" value="Rear View Camera" id="Rear View Camera" name="features[]" required>&nbsp;&nbsp;&nbsp;
                            <a class="text-center p-3" style="color:#000;" href="/Terms and conditions to seller.pdf" target="_blank">Terms And
                                Conditions<br></a>
                        </div>
