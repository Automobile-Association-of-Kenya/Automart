    ...
    <div class="widget advanced-search2">
        ...
        <form method="GET" id="vehiclesSearchForm" action="{{ route('search') }}">
            ...
            <div class="form-group">
                <select class="form-select form-select-md" name="type_id" id="filterVehicleType">

                </select>
            </div>

            <div class="form-group">
                <select class="form-select form-select-md" name="make_id" id="filterMakesID">
            ...
            <div class="range-slider clearfix">
                <label>Price</label>
                <div data-min="0" data-max="20000000" data-min-name="min_price" data-max-name="max_price"
