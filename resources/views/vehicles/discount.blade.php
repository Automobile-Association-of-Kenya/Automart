            ...
            <div class="row">
                ...
                <div class="col-lg-9 col-md-12">
                        ...
                        <div class="row">
                            <div class="col-lg-5 col-md-6 col-sm-12">
                                <div class="sorting-options2">
                                    <h5>Showing 1-20 of <span id="countResults">{{ count($discountedvehicles) }}</span> Vehicles</h5>
                                </div>
                            </div>
                    ...
                    <div class="row" id="vehiclesection">
                        @foreach ($discountedvehicles as $item)
                            @php
                                ...
                                <div class="car-box-3">
                                    <div class="car-thumbnail">
                                        <a href="#" class="car-img">
                                            ...
                                            <div class="price-box">
                                                <span class="del">Kes: <del>{{ number_format($item->initial_price, 2) }}</del></span><br>
